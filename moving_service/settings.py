"""
Django settings for moving_service project.
...
SECRET_KEY = 'super-long-secret-key-here'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'moving_service_db',
        'USER': 'moving_service_user',
...
LOGOUT_REDIRECT_URL = 'home'  # backup if not specified in LogoutView
